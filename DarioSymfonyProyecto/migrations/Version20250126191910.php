 ...
 */
final class Version20250126191910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cancion (id INT AUTO_INCREMENT NOT NULL, genero_id INT NOT NULL, titulo VARCHAR(255) NOT NULL, duracion INT NOT NULL, album VARCHAR(255) NOT NULL, autor VARCHAR(255) NOT NULL, reproducciones INT NOT NULL, likes INT NOT NULL, INDEX IDX_E4620FA0BCE7B795 (genero_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE perfil (id INT AUTO_INCREMENT NOT NULL, estilo_musical_preferido_id INT DEFAULT NULL, foto VARCHAR(255) NOT NULL, descripcion VARCHAR(255) NOT NULL, INDEX IDX_966576471C9C8804 (estilo_musical_preferido_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE playlist (id INT AUTO_INCREMENT NOT NULL, propietario_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, visibilidad VARCHAR(255) NOT NULL, reproduciones INT NOT NULL, likes INT NOT NULL, INDEX IDX_D782112D53C8D32C (propietario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE perfil ADD CONSTRAINT FK_966576471C9C8804 FOREIGN KEY (estilo_musical_preferido_id) REFERENCES estilo (id)');
